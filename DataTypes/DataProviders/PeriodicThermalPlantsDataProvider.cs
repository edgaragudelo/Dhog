...
{
    public class PeriodicThermalPlantsDataProvider
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(PeriodicThermalPlantsDataProvider));
        ...
        public PeriodicConventionalPlantsCollectionViewModel GetObjects()
        {
            ...
            List<PeriodicConventionalPlant> dataObjects = PeriodicThermalPlantsDataAccess.GetPeriodicThermalPlants();
            ...
            if (e.Action == NotifyCollectionChangedAction.Remove)
            {
                try
                {
                    foreach (object item in e.OldItems)
                    {
                        ...
                        PeriodicThermalPlantsDataAccess.DeletePeriodicThermalPlant(UIObject.GetDataObject());
                    }
                }
                catch (Exception ex)
                {
        ...
        void ObjectsItemEndEdit(IEditableObject sender)
        {
            ...
            try
            {
                if (UIObject.Name != null )
                    PeriodicThermalPlantsDataAccess.UpdatePeriodicThermalPlant(UIObject.GetDataObject());
            }
            catch (Exception ex)
            {
                log.Error(ex.StackTrace);
